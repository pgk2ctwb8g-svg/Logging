...
### Direkt mit AeroDataBox (RapidAPI)
Falls du keinen eigenen Proxy laufen hast, kannst du jetzt im UI ein Feld „RapidAPI Key (AeroDataBox)“ füllen. Dann ruft die App direkt `https://aerodatabox.p.rapidapi.com/flights/airports/iata/<AIRPORT>` im Fenster von ±30 Minuten um „jetzt“ auf (inkl. Codeshares, ohne Cargo/Privat). Der Key bleibt ausschließlich im Browser-Storage und liegt nicht im Repo.
