...
- Flugvorschläge im ±15-Minuten-Fenster mit automatischer Übernahme von Flugnummer, Airline-Code und Aircraft Type (Sample-Daten als Fallback).
...
5. Test: `curl "http://localhost:8788/flights?airport=MUC&direction=departure"` – Zeitfenster wird automatisch auf ±15 Minuten gesetzt, wenn `start/end` fehlen.
